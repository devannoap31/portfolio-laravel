            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
                ...
                <form action="{{ route('admin.education.update', $education->id) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="school_name" name="school_name" required value="{{ old('school_name', $education->school_name) }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition">
                    ...
                    <div>
                        ...
                        <input type="text" id="degree" name="degree" required value="{{ old('degree', $education->degree) }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="start_year" name="start_year" required value="{{ old('start_year', $education->start_year) }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition">
                        ...
                        <div>
                            ...
                            <input type="text" id="end_year" name="end_year" value="{{ old('end_year', $education->end_year) }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition">
