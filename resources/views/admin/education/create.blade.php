        ...
        <div class="bg-white border-[5px] border-black p-8 rounded-none">
            ...
            <form action="{{ route('admin.education.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="school_name" name="school_name" required value="{{ old('school_name') }}" class="w-full px-4 py-3 border-[3px] border-black rounded-none bg-white text-black font-['Work_Sans'] text-base focus:border-[5px] focus:ring-0 outline-none transition-none">
                ...
                <div>
                    ...
                    <input type="text" id="degree" name="degree" required value="{{ old('degree') }}" placeholder="CONTOH: S1 - TEKNIK PERANGKAT LUNAK" class="w-full px-4 py-3 border-[3px] border-black rounded-none bg-white text-black font-['Work_Sans'] text-base focus:border-[5px] focus:ring-0 outline-none transition-none placeholder:text-slate-400 placeholder:font-['Space_Mono']">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="start_year" name="start_year" required value="{{ old('start_year') }}" placeholder="CONTOH: 2024" class="w-full px-4 py-3 border-[3px] border-black rounded-none bg-white text-black font-['Work_Sans'] text-base focus:border-[5px] focus:ring-0 outline-none transition-none placeholder:text-slate-400 placeholder:font-['Space_Mono']">
                    ...
                    <div>
                        ...
                        <input type="text" id="end_year" name="end_year" value="{{ old('end_year') }}" placeholder="CONTOH: 2028" class="w-full px-4 py-3 border-[3px] border-black rounded-none bg-white text-black font-['Work_Sans'] text-base focus:border-[5px] focus:ring-0 outline-none transition-none placeholder:text-slate-400 placeholder:font-['Space_Mono']">
